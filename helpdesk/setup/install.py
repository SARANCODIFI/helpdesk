...
# from  helpdesk.patches.hd_ticket.hd_ticket_fields import custom_execute
from  helpdesk.patches.hd_ticket.ticket_type_custom_fields import hd_ticket_type_execute
...
def after_install():
	...
	# custom_execute() # Hd Ticket
	hd_ticket_type_execute()
