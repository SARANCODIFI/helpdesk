...
export const CUSTOMER_PORTAL_NEW_TICKET_INTERNAL = "TicketNewInternal";
...
export const AGENT_PORTAL_TICKET_INTERNAL = "TicketAgentInternal";
...
//
export const AGENT_PORTAL_TICKET_LIST_INTERNAL = "TAgentInternal";
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "internalticket",
        name: AGENT_PORTAL_TICKET_LIST_INTERNAL,
        component: () => getPage("TAgentInternal"),
      },
      {
      ...
      {
        path: "internaltickets/new/:templateId?",
        name: "TicketAgentNewInternal",
        component: () => getPage("TicketNewInternal"),
        props: true,
        meta: {
          onSuccessRoute: "TicketAgentInternal",
          parent: "TAgentInternal",
        },
      },
      {
      ...
      },
      {
        ...
        component: () => getPage("TicketAgentInternal"),
        props: true,
      },
      {
        path: "kb",
